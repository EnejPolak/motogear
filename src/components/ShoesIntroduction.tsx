...
export default function ShoesIntroduction() {
  return (
    <section id="shoes-introduction" className="min-h-screen w-screen bg-black text-white py-20 relative overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-to-l from-[#FF3C00]/5 to-orange-500/3 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-gradient-to-r from-slate-600/8 to-zinc-500/5 rounded-full blur-3xl" />
      </div>
            ...
            <div className="max-w-lg">
              ...
              <div className="inline-block mb-6">
                <div className="bg-gradient-to-r from-[#FF3C00]/20 to-orange-500/10 border border-[#FF3C00]/30 rounded-full px-6 py-2 backdrop-blur-sm">
                  <span className="text-[#FF3C00] text-sm font-semibold tracking-wider uppercase">Professional Racing Boots</span>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <span className="text-slate-400 text-lg ml-2 line-through">€280</span>
              </div>

              {/* Description */}
              <p className="text-[#D1D5DB] text-lg md:text-xl leading-relaxed mb-8">
                High-performance racing boots designed for maximum protection and comfort. 
                Engineered with advanced materials and precision construction for professional riders.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-slate-200">Full-grain leather construction</span>
                </div>
                <div className="flex items-center">
                  <span className="text-[#FF3C00] mr-3 text-xl">✓</span>
                  <span className="text-slate-200">CE Level 2 ankle protection</span>
                </div>
                <div className="flex items-center">
                  <span className="text-[#FF3C00] mr-3 text-xl">✓</span>
                  <span className="text-slate-200">Reinforced toe and heel areas</span>
                </div>
                <div className="flex items-center">
                  <span className="text-[#FF3C00] mr-3 text-xl">✓</span>
                  <span className="text-slate-200">Adjustable closure system</span>
                </div>
                <div className="flex items-center">
                  <span className="text-[#FF3C00] mr-3 text-xl">✓</span>
                  <span className="text-slate-200">Waterproof and breathable</span>
                </div>
              </div>
              ...
              <div className="bg-slate-800/30 rounded-xl p-6 border border-slate-700/30 backdrop-blur-sm mb-8">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-100">Full-grain Leather</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-100">1.2kg</span>
                  </div>
                </div>
              </div>
