...
import { GLOVE_PART_LABELS } from '@/types/glove';
import { COLOR_PALETTE } from '@/types/configurator';
import ColorSwatch from './ColorSwatch';

interface GloveBottomPanelProps {
  activePart: string;
...
export default function GloveBottomPanel({
  activePart,
  activePartIndex,
  totalParts,
  selectedColor,
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center gap-3 px-8">
              <h3 className="text-xl font-semibold text-slate-100">{GLOVE_PART_LABELS[activePart as keyof typeof GLOVE_PART_LABELS]}</h3>
            </div>
